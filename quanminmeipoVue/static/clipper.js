...
export default {
  install( Vue ){
    ...
    Vue.prototype.postImg = function( imageData ) {
      //这边写图片的上传
      let self = this;
      console.log(self.sdkData)
      /*const cos=new COS({
        AppId: self.sdkData.appid,
        SecretId: 'AKIDxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        SecretKey: 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
      })
      cos.sliceUploadFile({
        Bucket: self.sdkData.bucket,
        Region: self.sdkData.setRegion,
        Key: imageData,
        Body:self.sdkData.fileName,
      }, function (err, data) {
        console.log(err);
        console.log(data);
      });*/
